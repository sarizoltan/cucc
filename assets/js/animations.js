...
function initializeHeroAnimations() {
  ...
  // MÓDOSÍTVA: Hotspot animációk - eltávolítva a végtelen ismétlés
  gsap.utils.toArray('.hotspot').forEach(hotspot => {
    // Csak egyszer animál be az oldal betöltésekor
    gsap.fromTo(hotspot, 
      {
        scale: 0.8,
        opacity: 0
      },
      {
        ...
        duration: 0.8,
        ease: 'back.out(1.7)',
        delay: 1.5 // Kis késleltetés a hero animációk után
      }
    );

    // Hover effekt hozzáadása helyette
...
// Benefits timeline animations - JAVÍTOTT VERZIÓ
...
console.log('🎨 Advanced animations initialized! (Fixed version - no continuous movement)');